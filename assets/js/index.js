		...
		$(window).scroll(function(){
			...
			if (screen.width < 641) {
				if (bodyScrollTop > 180){
					...
					if (!visible) {
						nav.append('<a href="#cover"><img id="logo-black" class="navbar-logo logo-black" src="assets/images/logos/logo10.png" alt="AM Studio Shopify Web Development Logo"></a>');
						$('#logo-white').remove();
						visible = true;
					} 
					...
					if (visible) {
						nav.append('<a href="#cover"><img id="logo-white" class="navbar-logo logo-white" src="assets/images/logos/logo9.png" alt="AM Studio Shopify Web Development Logo"></a>');
						$('#logo-black').remove();
						visible = false;
					}
				}
